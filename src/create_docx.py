...
def create_lgbm_report(auc_score, accuracy, classification_report_str, top_feature_importance_list, importance_plot_buffer, training_log_str, roc_plot_buffer, output_path):
    document = Document()
...
def create_rf_report(accuracy, classification_report_str, feature_importance_list, importance_plot_buffer, output_path):
    document = Document()
